      ...
      <MainLayout 
        ...
        content={
          ...
          <Hero 
            ...
            subtitle="Mytest testingapproach to product, and life, is centered around listening and being creative. For me, listening comes from a curiosity to understand what makes people tick, and creativity comes from being open. Both benefit from lots of practice."
          />
            <ExperienceSection />
          </>
        }
